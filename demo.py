...
"}")
        ...
        self.plot_Label = QtWidgets.QLabel(self.tab)
        self.plot_Label.setGeometry(QtCore.QRect(540, 80, 351, 421))
        self.plot_Label.setObjectName("plot_Label")
        self.label_needle1_3 = QtWidgets.QLabel(self.tab)
        self.label_needle1_3.setGeometry(QtCore.QRect(543, 20, 351, 33))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
